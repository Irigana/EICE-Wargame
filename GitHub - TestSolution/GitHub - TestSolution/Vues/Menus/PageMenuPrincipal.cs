...
namespace EICE_WARGAME
{
    public partial class PageMenuPrincipal : UserControl
    {
        ...
        private void buttonMaCollection_Click(object sender, EventArgs e)
        {
            Form_Principal.Instance.CreerPageCourante<PageMaCollection>(                                   
                (page) =>    
                {
                    page.Utilisateur = Utilisateur;
                    return true;
       ...
       private void buttonMesArmees_Click(object sender, EventArgs e)
        {
            Form_Principal.Instance.CreerPageCourante<PageArmee>(
                (page) =>
                {
                    page.Utilisateur = Utilisateur;
                    return true;
